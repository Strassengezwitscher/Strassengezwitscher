...
class ViewTests(TestCase):
    ...
    def test_valid_captcha_response(self):
        ...
        """
        response = self.client.post(reverse('captcha:validate_captcha'), {'response': self.valid_greponse})
        self.assertEqual(response.status_code, 200)
        self.assertEqual(response.json()['status'], 'success')

    def test_wrong_captcha_reponse(self):
        """
    ...
    def test_empty_captcha_reponse(self):
        """
